...
export default function handler(req, res) {
  res.status(200).json({
    ...
    toolsAndTechSkills: ["Communication skills","Customer service skills","Teamwork","Time management","Attention to detail","Others"],
    ...
    industryKnowledge: ["Hospitality Sector Understanding","Customer Behavior","Trends and Practices","F&B Operations","Sales and Marketing","Others"],
    ...
    languages: ["English","Nepali","Hindi","Spanish","Mandarin","French"],
    projects: [
      {
        title: "halid.dev",
