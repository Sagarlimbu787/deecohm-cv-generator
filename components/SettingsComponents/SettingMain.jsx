  ...
  return (
    <AnimatePresence>
      <motion.div layout className="cardStyle">
        ...
        <div className="mt-5">
          <p>
          The CV Generator is a user-friendly tool that enables students to create a CV that highlights their strengths, skills, and achievements in a professional and concise manner. It offers a range of customizable templates and designs that enable students to create a CV that reflects their unique personality and style. <br/><br/>

          The CV Generator also includes a range of features that make it easy for students to create a CV that stands out from the rest. These features include the ability to add a profile picture, highlight key achievements and accomplishments, and customize the layout and design of the CV.
          </p>
